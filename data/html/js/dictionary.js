dictionary = [
    ...
    "Aigner",
    "Ziva",
    "Robert Graham Freshly Laundered",
    "Moda in Pelle",
    "Dachstein",
    "MOA - Master of Arts",
    "Peugeot",
    ...
    "Nana",
    "Altea",
    "Suspender Factory of San Francisco",
    "B.T. Kids",
    "Anna Sui",
    "Jetoy",
    "Capas",
    ...
    "Peuterey",
    "Enza Nucci",
    "\u00eatre c\u00e9cile presque parisienne",
    "3M",
    "Patrik Ervell",
    "Heartland",
    "Redfield",
    ...
    "PureDay",
    "O2",
    "AD Admirabilis Domus",
    "HUGO BOSS",
    "Fluent Life",
    "Little Pieces Boys",
    "Cooperative by Urban Outfitters",
    "Fersengold",
    "Dorothy Perkins",
    "FX",
    "Twin Six",
    ...
    "Vertical Design",
    "Stuf",
    "Truly Madly Deeply by Urban Outfitters",
    "Bermans",
    "Cuisipro",
    "Signum",
    "Vilagallo",
    ...
    "D.S.DUNDEE",
    "PEZZI",
    "Pins + Needles by Urban Outfitters",
    "RedHead",
    "Thalia Sodi",
    "Mephisto",
    "Antonio Melani",
    ...
    "Golla",
    "Hansen",
    "The Great American Buckle Company",
    "Gr\u00e4fin von Liebstedt",
    "Made for Loving",
    "Santoni",
    "Emerica",
    "Corral Boots",
    ...
    "Fioni",
    "Erazor Bits",
    "C\u00e9cile Presque Parisienne",
    "Seidensticker Uno Super Slim",
    "Belle Du Jour",
    "Planet Earth",
    "Canari",
    "Reiss",
    ...
    "\u00e9s",
    "Candice Cooper",
    "Studio 148 by Lafayette New York",
    "REI",
    "REN",
    "Animal",
    "Dynomighty Design",
    ...
    "Gear 1",
    "Bobby J",
    "Matthew Williamson for Ballantyne",
    "Ecko Red",
    "Rock Steady",
    "Aloha Republic",
    "Self",
    ...
    "IG Eyewear",
    "Viper",
    "Shore Leave by Urban Outfitters",
    "Louise Ricci",
    "Coconel",
    "Shanghai",
    "Fraas",
    ...
    "Vertigo",
    "Naketano",
    "Roksanda Ilincic Swimwear",
    "Fred Mello",
    "MSR",
    "Bubblegum",
    "Pro-Tec",
    "HomeArt by Present Time",
    "MSK",
    "Ergobag",
    ...
    "Zeha Berlin",
    "Madison Studio",
    "Jimi Hendrix by English Laundry",
    "Genova",
    "Braggi",
    "Invotis",
    "Yes to Carrots",
    ...
    "Betmar",
    "Brittania",
    "Maison Fabre pour Chantal Thomass",
    "Graphic Image",
    "H\u00e4hnel",
    "Liebestuch",
    "Icepeak",
    ...
    "Elten",
    "Mediven",
    "R&J Handbags by Romeo & Juliet Couture",
    "pediped",
    "Liquid",
    "Suncoo",
    "Sangria",
    ...
    "Paquetage",
    "BP Studio",
    "Colors made with Swarovski Elements_2",
    "Masterhand",
    "Universal",
    "House of Der\u00e9on",
    "B-Line",
    ...
    "Ben Davis",
    "Eskina",
    "Light Before Dark by Urban Outfitters",
    "Softwaves",
    "Joyce",
    "Kost",
    "Tsukihoshi",
    ...
    "Rehall",
    "Flap Happy",
    "Lounge Special Deals",
    "David Carey",
    "Lauren Jones",
    "NordicTrack",
    "Pieces",
    "Sartorial Leisure by Oscar Jacobson",
    "Weatherproof",
    "5ive Jungle",
    "Verge",
    "holiday plus",
    ...
    "snoozies!",
    "Carlo Monti",
    "Sparkle & Fade by Urban Outfitters",
    "Hot Topic",
    "Prophecy",
    ...
    "Decay",
    "Supreme Being by Urban Outfitters",
    "Jeansian",
    "Inge-Glas",
    "MedGear",
    "Predator",
    ...
    "Nick Danger",
    "Design Options",
    "adidas Consortium by Y's",
    "Herzog & S\u00f6hne",
    "Penthouse",
    "English Heritage by Christy",
    "Womyn",
    "Colony",
    "Bigio Collection",
    "Shoe The Bear",
    ...
    "ALC",
    "Aventura",
    "Silence + Noise by Urban Outfitters",
    "Matterhorn",
    "Morphine Generation",
    "Villeroy & Boch",
    "C1RCA",
    ...
    "Wadsworth",
    "Cavalier",
    "Kardashian Kollection at Lipsy",
    "K2",
    "Clubbing",
